...
module.exports = {
  ...
  plugins: [new HtmlWebpackPlugin({
    template: "./public/index.html" // chunks:["main"]//控制模板html中自动引入哪些的chunks中的衍生文件(例如经过loader处理的css文件、和经过webpack编译的js文件)

  }), new CleanWebpackPlugin(), new MiniCssExtractPlugin({
    //负责生成css文件同时放置记录css-style生成的总的内容到其中
    //此处配置生成的css文件的位置以及名称
