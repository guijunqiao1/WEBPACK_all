...
module.exports = {
  ...
  plugins:[
    ...
    new DeepScope(),//简单的深度作用域下是否使用模块内容的分析,协助tree shaking
    new MiniCss(),
    new Purgecss({
      paths //等价paths:paths，此处的路径内容中即包含html文件也包含html文件的原因在于需要结合整体的dom对象中的dom以及CSSOM树进行
